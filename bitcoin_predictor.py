...
class GRU:
    ...
    def __init__(self, in_size: int, out_size: int, hidden_size: int):
        ...
        self.Wxc = np.random.randn(hidden_size, in_size) * 0.1
        self.Wxr = np.random.randn(hidden_size, in_size) * 0.1
        self.Wxz = np.random.randn(hidden_size, in_size) * 0.1
        
        # Hidden to hidden weights
        self.Rhc = np.random.randn(hidden_size, hidden_size) * 0.1
        self.Rhr = np.random.randn(hidden_size, hidden_size) * 0.1
        self.Rhz = np.random.randn(hidden_size, hidden_size) * 0.1
        
        # Output weights
        self.Why = np.random.randn(out_size, hidden_size) * 0.1
